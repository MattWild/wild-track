...
public class HANDevice extends Entry {
	...
	public HANDevice(Main app, String unitIDString, String deviceNameString, String installCodeString, String macAddressString,String locString, String commentString) {
		super(app);
